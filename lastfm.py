...
class lastfm_controller:	
	...
	def get_album_info_query(self, artist, album):	    	    
	    ...
	    data = {"api_key" : API_KEY, 'artist' : artist, 'album' : album, 'autocorrect' : '1', 'method' : 'album.getinfo'}
	...
	def get_top_albums_query(self, artist):
	    ...
	    data = {"api_key" : API_KEY, 'artist' : artist, 'autocorrect' : '1', 'method' : 'artist.getTopAlbums'}
	    return ul.unquote(ul.urlencode(data))
	...
	def get_top_tracks_query(self, artist):
	    ...
	    data = {"api_key" : API_KEY, 'artist' : artist, 'autocorrect' : '1', 'method' : 'artist.getTopTracks'}
	    return ul.unquote(ul.urlencode(data))
